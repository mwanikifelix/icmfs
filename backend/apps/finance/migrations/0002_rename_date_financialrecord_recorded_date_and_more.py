...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='financialrecord',
            name='progress',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='financial_links', to='progress.dailyprogress'),
        ),
        migrations.AddField(
            model_name='financialrecord',
            name='recorded_by',
        ...
        migrations.AlterField(
            model_name='financialrecord',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='financial_records', to='projects.project'),
        ),
